...
#+end_src
**** Enabling programming ligatures :ARCHIVE:
...
#+end_src
*** Theme
I [[https://github.com/dylanaraps/pywal][pywal]] for my theming so I use [[https://github.com/cyruseuros/ewal][this]] as my theme.
#+begin_src emacs-lisp
