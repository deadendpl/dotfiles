...
I have =use-package-always-ensure= because otherwise pacakges didn't want to download with =use-package-always-defer=.
#+begin_src emacs-lisp
...
[[https://github.com/emacs-evil/evil-collection][Evill collection]] has preconfigured evil keybindings for some essential emacs packages.
#+begin_src emacs-lisp
...
[[https://github.com/redguardtoo/evil-nerd-commenter][Evil nerd commenter]] is convenient comeenting thing
#+begin_src emacs-lisp
